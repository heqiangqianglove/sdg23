...
public class CodeGen3531 {
    ...
    public static void main(String[] args) {
        ...
        String[] tables={ "governance_assess_detail","governance_metric", "governance_type"};

        FastAutoGenerator.create("jdbc:mysql://hadoop102:3306/dga_230201","root","000000")
                .globalConfig(builder -> {
                    builder.author("heqiangqiang")               //作者
                            .outputDir("C:\\Users\\11544\\IdeaProjects\\sdg23\\src\\main\\java")    //输出路径(写到java目录)
                            .commentDate("yyyy-MM-dd")
                            .dateType(DateType.ONLY_DATE);  //选择实体类中的日期类型  ，Date or LocalDatetime
                })
                .packageConfig(builder -> {                 //各个package 名称
                    builder.parent("com.atguigu.sdg")
